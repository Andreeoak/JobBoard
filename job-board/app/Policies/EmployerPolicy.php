...
class EmployerPolicy
{
    ...
    {
        return null===$user->employer; // Only allow users without an employer to create a new one
    }
    ...
    {
        return $employer->user_id === $user->id; // Allow update if the employer belongs to the user
    }
